...
ELASTIC_INDEX="processed"
SAMPLE_SIZE=1
consumer=KafkaConsumer('spark-output',bootstrap_servers=KAFKA_ADDRESS,group_id="processed-elastic-connector")
    ...
    while True:
        for item in items:
            try:
                ...
                producer.send(**{"topic":'committed-spark-output', "value":item})
